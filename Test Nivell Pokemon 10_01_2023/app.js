...
let pokemons = [
    ...
    new Pokemon ('2', 'Boris',2,'agua',[{nombre : 'Ataque acuatico', potencia : 4},  {nombre : 'Ataque terrestre', potencia : 3}, {nom : 'Ataque electrico', potencia : 1}]), 
    new Pokemon ('3', 'Ivan',1,'electrico',[{nombre : 'Ataque electrico', potencia : 4},  {nombre : 'Ataque freidor', potencia : 2}, {nom : 'Ataque electrico', potencia : 1}]), 
    ...
    new Pokemon ('6', 'Jordi',6,'planta', [{nombre : 'Ataque freidor', potencia : 3}, {nombre : 'Ataque acuatico', potencia : 3}, {nom : 'Ataque volador', potencia : 2}])
